                ...
                >
                    <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-base sm:text-lg md:text-xl max-w-xl leading-relaxed">
                            SEO STRATEGIST & DIGITAL INNOVATOR  with 4+ years of experience across agency and in-house environments. I prioritise business impact and customer value above all else.
                        </p>
                    </div>
