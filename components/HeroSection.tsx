...
export function HeroSection() {
    return (
        <section className="relative min-h-screen flex items-center pt-20 px-6 md:px-12 lg:px-24 overflow-hidden bg-background">
            ...
            <div className="container max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Button size="xl" className="rounded-full px-8 bg-primary text-primary-foreground hover:opacity-90 font-bold tracking-wide shadow-lg shadow-primary/20" asChild>
                            <Link href="/case-studies">View Case Studies</Link>
                        </Button>
                        <Button size="xl" variant="outline" className="rounded-full px-8 border-primary/20 hover:bg-primary/5 text-foreground font-bold tracking-wide" asChild>
                            <Link href="#contact">Book a Strategy Call</Link>
                        </Button>
                    </div>

                    {/* Social proof/metrics */}
                    <div className="flex items-center gap-8 pt-4 border-t border-border w-fit">
                        <div className="flex flex-col">
                            <span className="text-2xl font-bold">29+</span>
                            <span className="text-xs text-muted-foreground uppercase tracking-widest font-semibold">Projects</span>
                        </div>
                        <div className="h-10 w-px bg-border hidden sm:block" />
                        <div className="flex flex-col">
                            <span className="text-2xl font-bold">+175%</span>
                            <span className="text-xs text-muted-foreground uppercase tracking-widest font-semibold">Avg. Growth</span>
                        </div>
                    </div>
                </motion.div>
